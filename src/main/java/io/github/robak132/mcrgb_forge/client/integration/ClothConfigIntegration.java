...
public final class ClothConfigIntegration {
    ...
    private static final Function<Boolean, Component> alwaysShowToolTipsTextSupplier = value ->
            Component.translatable(value ? Localisation.OPTIONS_ALL_CONTEXTS : Localisation.OPTIONS_PICKER_ONLY);
    private static final Function<Boolean, Component> sliderConstantUpdateTextSupplier = value ->
            Component.translatable(value
                    ? Localisation.OPTIONS_WHILE_SCROLLING
                    : Localisation.OPTIONS_AFTER_SCROLLING);
    ...
    public static Screen getConfigScreen(Screen parent) {
        ConfigBuilder builder = ConfigBuilder.create().setParentScreen(parent)
                .setTitle(Component.translatable(Localisation.CONFIG_TITLE))
        ...
        BooleanToggleBuilder alwaysShowToolTip = entryBuilder.startBooleanToggle(
                Component.translatable(Localisation.OPTION_ALWAYS_SHOW_TOOLTIPS),
        ...
        alwaysShowToolTip.setDefaultValue(ALWAYS_SHOW_TOOLTIPS.getDefault())
                ...
                .setTooltip(Component.translatable(Localisation.TOOLTIP_ALWAYS_SHOW_TOOLTIPS)).build();
        configs.addEntry(alwaysShowToolTip.build());

        configs.addEntry(entryBuilder.startIntField(Component.translatable(Localisation.OPTION_MAX_TOOLTIP_LINES),
                        MAX_TOOLTIP_LINES.get())
                .setDefaultValue(MAX_TOOLTIP_LINES.getDefault()).setMin(1).setMax(100)
                .setSaveConsumer(MAX_TOOLTIP_LINES::set)
        ...
        BooleanToggleBuilder sliderConstantUpdate = entryBuilder.startBooleanToggle(
                Component.translatable(Localisation.OPTION_SLIDER_CONSTANT_UPDATE),
        ...
        sliderConstantUpdate.setDefaultValue(SLIDER_CONSTANT_UPDATE.getDefault())
                ...
                .setTooltip(Component.translatable(Localisation.TOOLTIP_SLIDER_CONSTANT_UPDATE)).build();
        configs.addEntry(sliderConstantUpdate.build());

        ColorCalculationMode initialCalculationMode = COLOR_CALCULATION_MODE.get();
        configs.addEntry(
                entryBuilder.startEnumSelector(Component.translatable(Localisation.OPTION_COLOR_MODE),
                                ColorCalculationMode.class, COLOR_CALCULATION_MODE.get())
                        .setDefaultValue(COLOR_CALCULATION_MODE.getDefault())
                        .setEnumNameProvider(value -> Component.translatable(Localisation.colorMode(value)))
                        .setSaveConsumer(COLOR_CALCULATION_MODE::set)
                        .setTooltip(Component.translatable(Localisation.TOOLTIP_COLOR_MODE)).build());

        var itemSpawningMode = entryBuilder.startEnumSelector(
                        Component.translatable(Localisation.OPTION_ITEM_SPAWNING_MODE), ItemSpawningMode.class,
                        ITEM_SPAWNING_MODE.get()).setDefaultValue(ITEM_SPAWNING_MODE.getDefault())
                .setEnumNameProvider(value -> Component.translatable(Localisation.itemSpawningMode(value)))
                .setSaveConsumer(ITEM_SPAWNING_MODE::set)
        ...
        StringFieldBuilder commandString = entryBuilder.startStrField(
                Component.translatable(Localisation.OPTION_GIVE_COMMAND), GIVE_COMMAND.get());
        ...
        BooleanToggleBuilder bypassOP = entryBuilder.startBooleanToggle(
                Component.translatable(Localisation.OPTION_BYPASS_OP), BYPASS_OP.get());
        bypassOP.setDefaultValue(BYPASS_OP.getDefault()).setSaveConsumer(BYPASS_OP::set)
                .setTooltip(Component.translatable(Localisation.TOOLTIP_BYPASS_OP));
    ...
    private static void requireGiveCommandMode(ValueHolder<ItemSpawningMode> itemSpawningMode,
            StringFieldBuilder commandString,
